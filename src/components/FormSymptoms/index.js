    ...
    <RegisterSymptoms className="content-container">
      <Form>
        ...
        <QuestionMultiAnswer classNameContainer="symptoms-check show" classNameSubContainer="one-SubContainer" // All questions in one array for send it trough of props
          ...
          questions={[{
            'attributes': 'breathe',
            'answerText': 'Luchando por respirar o luchando por respirar incluso cuando está inactivo o cuando descansa'
          },
          {
            'attributes': 'collapse',
            'answerText': 'Se siente a punto de colapsar cada vez que se pone de pie o se sienta (flojera o falta de respuesta en un niño menor de 2 años)'
          },
          {
            'attributes': 'none',
        ...
        />
        <ButtonSymptoms className="symptoms-send show" onClick={handleClick}>Siguiente pregunta</ButtonSymptoms>
        <ButtonSymptoms className="symptoms-send" onClick={handleClick2}>Enviar datos</ButtonSymptoms>
      </Form>
    </RegisterSymptoms>
  );
};
